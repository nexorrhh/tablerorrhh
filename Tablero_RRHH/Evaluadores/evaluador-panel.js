    ...
    btnGuardar.addEventListener('click', async () => {
      ...
      try {
        const body = {
          ...
          // Redondeado: evaluacion_superior es una columna entera en la base, y el promedio
          // aptitudinal/operativa puede dar con decimales (ej. 75 y 50 → 62.5) — sin esto
          // Supabase rechaza el guardado con error 400.
          evaluacion_superior: Math.round((calc.evaluacion_aptitudinal + calc.evaluacion_operativa) / 2),
