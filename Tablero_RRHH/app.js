...
import { renderizarDesempenoEvaluadores }     from './components/desempeno-evaluadores.js';
...
async function renderizarContenido() {
  ...
  } else if (submod.tipo === 'desem-evaluadores') {
    await renderizarDesempenoEvaluadores(contenedor);
