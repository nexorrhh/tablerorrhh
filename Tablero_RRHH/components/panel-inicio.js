...
export async function renderizarPanel(contenedor) {
  ...
  contenedor.innerHTML = `
    <div class="panel">
      ...
      <p class="panel__seccion-titulo">Cumpleaños y Aniversarios</p>
      <div class="panel__personas-grid">
  ...
  // ── Carga en paralelo ───────────────────────────────────────────────────────
  const [rEmpleados, rFechas, rPreselMeses, rPostMeses, rIngresos] = await Promise.allSettled([
