...
export const CODIGOS_EXCLUIDOS_AUSENTISMO = new Set(['VACACION', 'VIAJE']);
...
export async function renderizarPresentismoIndicadores(contenedor) {
  ...
  contenedor.innerHTML = `<div class="pind">
    ...
    <!-- Selector de grupo — decide cuál de las dos secciones de abajo se muestra -->
    <div class="pind__grupo-ver">
      <span class="pind__grupo-ver-lbl">Ver información de:</span>
      <div class="pind__grupo-ver-switch" role="tablist" aria-label="Elegir grupo de personal">
        <button class="pind__grupo-ver-btn pind__grupo-ver-btn--activo" data-grupo-ver="q" type="button" role="tab" aria-selected="true">Quincenales — Personal de taller</button>
