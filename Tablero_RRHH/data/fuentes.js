...
// ── Nexo RRHH (backend de Permisos) ──────────────────────────────────────────
// Dos tenants independientes (un proyecto Supabase por razón social), misma Edge
// Function ("rapid-function") en cada uno. Se llama por POST con ?action=<nombre>
// y body { api_key, ...resto } — ver data/nexo-permisos.js para el helper de llamada.
// La api_key acá es la clave propia de esta Edge Function (no es la anon key de
// Supabase) — es la que ya usa el otro tablero para el mismo backend.
export const NEXO_CONFIG = {
  cimomet: {
    url:    'https://qnqikspihpljzvojlpak.supabase.co/functions/v1/rapid-function',
    apiKey: '09ce6239-0544-4373-99db-d195be3ada17',
  },
  comoing: {
    url:    'https://dbcfbhblwezcvtqtrxkm.supabase.co/functions/v1/rapid-function',
    apiKey: '09ce6239-0544-4373-99db-d195be3ada17',
  },
};
